...
![alt text](images/biu_system_bus_tb.png)
...
later, I need to make this compatible with memory writes. in case of writes, the master must end the transaction. in case of reads, the slave ends the transaction.
